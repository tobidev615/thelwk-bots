...
class UserAgentRotatorMiddleware(UserAgentMiddleware):
    ...
    def __init__(self, user_agent=''):
        ...
        # Update the user agent, everytime a request is sent 
    def process_request(self, request, spider):
        try:
            self.user_agent = secrets.choice(self.my_agents)
            request.headers.setdefault('User-Agent', self.user_agent)
        except IndexError:
            logging.error("Couldn't Fetch the User agent ")

class SelchartsngSpiderMiddleware(object):
...
class SelchartsngDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
